    ...
    <section class="sheet">
        ...
        <article>
            ...
            <table class="" width="" align="center">
                ...
                @endphp
                <thead>
                    <tr><th colspan="8" class="text-center" style="font-size: 18px;">Outstanding Invoice Report</th></tr>
                    <tr><th colspan="8" class="text-center" >{{ date('d-m-Y', strtotime($request->start_date)) . ' TO ' . date('d-m-Y', strtotime($request->end_date)) }}</th></tr>
                    <tr>
                        <th>Invoice No</th>
                        <th>Inv Date</th>
                        <th>Company</th>
