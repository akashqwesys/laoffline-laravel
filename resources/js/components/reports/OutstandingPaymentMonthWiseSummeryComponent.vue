                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Outstanding Payment Month Wise Summert Report</h3>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                axios.post('/reports/list-outstanding-payment-month-wise-summery-data', {
                ...
                .then(response => {
                    ...
                    $('#salesRegister tbody').html(response.data.table);
                });
            },
            exportSheet() {
                this.export_sheet = 1;
