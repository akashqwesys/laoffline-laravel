                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Commission Collection Report</h3>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <multiselect v-model="mode" :options="mode_options"
                                                ...
                                                <td>
                                                    <multiselect v-model="fyear"
                                                        :options="fyear_options" label="name" track-by="id"
                                                        id="sorting"></multiselect>
                                                </td>
                                                <td class="">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            .then(response => {
                this.fyear_options = response.data;
                this.fyear = this.fyear_options[0];
            });
        },
        methods: {
            ...
            getData() {
                axios.post('/reports/list-commission-collection-data', {
