                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Percentage Evaluate Report</h3>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select v-model="sort_by" class="form-control">
                                                        ...
                                                        <option value="3">Invoice Amount: low -&gt; high</option>
                                                        <option value="4">Invoice Amount: high -&gt; low</option>
                                                    </select>
                                                </td>
                                                <td class="">
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            axios.post('/reports/list-percentage-evaluate-data', {
