                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Avarage Commission Days Report</h3>
                            ...
                            <div class="card-inner">
                                <div class="mb-5">
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th width="15%">Start Date( Invoice Date )</th>
                                                <th width="15%">End Date ( Invoice Date )</th>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                axios.post('/reports/list-avarage-commissions-days', {
