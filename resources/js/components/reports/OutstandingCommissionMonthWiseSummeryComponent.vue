                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Outstanding Commission Month Wise Summery Report - {{ customer_supplier }}</h3>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                axios.post('/reports/list-commission-outstanding-month-wise-summery-data', {
