                    ...
                    <div class="nk-block">
                        <div class="card card-bordered card-stretch">
                            ...
                            <div class="print_area">
                                ...
                                <div class="row">
                                    <label class="form-label">Courrier Name :  </label>{{ Outward.courier_name }} 
                                </div>
                                <div class="row">
                                    <label class="form-label">Courrier Receipt No :  </label>{{ Outward.courier_receipt_no }} 
                                </div>
                                <div class="row">
                                    <label class="form-label">Received Date Time :  </label>{{ Outward.courier_received_time }} 
                                </div>
                                 <div class="row">
