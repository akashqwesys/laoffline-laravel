                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                            ...
                            <table class="datatable-init-export nowrap">
                                <tr>
                                    ...
                                    <td style="text-align: right; padding-left:390px;">
                                        <b>Generated By:</b> B Vikas Chandra
                                        <b>Date Added:</b> 04/02/2022
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: right;">
                                        <b>Updated By:</b> B Vikas Chandra
                                        <b>Date Updated:</b> 04/02/2022
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: right;">
                                        <b>Verified By:</b> B Vikas Chandra
                                        <b>Date Verified:</b> 04/02/2022
                                    </td>
                                </tr>
                            </table>
                                ...
                                <div class="card-inner">
                                    <table
                                        ...
                                        <tr>
                                            ...
                                            <div
                                                v-for="(packagingDetails, index) in packagingDetails"
                                                :key="index" >
                                                <td
                                                    v-if="(packagingDetails.company_id) == (companyList.id)"
                                                >{{ packagingDetails.gst_no }}</td>
                                            </div>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div class="card card-bordered card-stretch">
                                <div class="card-inner">
                                    <table
                                        ...
                                        <tbody>
                                            <tr
                                                v-for="(multipleAddress, index) in multipleAddress"
                                                :key="index" >
                                                <td
                                                    v-if="(multipleAddress.company_id) == (companyList.id)"
                                                >{{ multipleAddress.name }}</td>
                                                <td
                                                    v-if="(multipleAddress.company_id) == (companyList.id)"
                                                >{{ multipleAddress.designation_name }}</td>
                                                <td
                                                    v-if="(multipleAddress.company_id) == (companyList.id)"
                                                >{{ multipleAddress.mobile }}</td>
                                                <td
                                                    v-if="(multipleAddress.company_id) == (companyList.id)"
                                                >{{ multipleAddress.email }}</td>
                                            </tr>
                                            <tr
                                                v-for="(companyContactDetails, index) in companyContactDetails"
                                                :key="index" >
                                                <td
                                                    v-if="(companyContactDetails.company_id) == (companyList.id)"
                                                >{{ companyContactDetails.contact_person_name }}</td>
                                                <td
                                                    v-if="(companyContactDetails.company_id) == (companyList.id)"
                                                >{{ companyContactDetails.name }}</td>
                                                <td
                                                    v-if="(companyContactDetails.company_id) == (companyList.id)"
                                                >{{ companyContactDetails.contact_person_mobile }}</td>
                                                <td
                                                    v-if="(companyContactDetails.company_id) == (companyList.id)"
                                                >{{ companyContactDetails.contact_person_email }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="card card-bordered card-stretch">
                                <div class="card-inner">
                                    <table
                                        ...
                                        <tbody>
                                            <tr
                                                v-for="(companyAddress, index) in companyAddress"
                                                :key="index" >
                                                <td>
                                                    <em class="icon ni ni-plus"></em>
                                                </td>
                                                <td
                                                    v-if="(companyAddress.company_id) == (companyList.id)"
                                                >{{ companyAddress.name }}</td>
                                                <td
                                                    v-if="(companyAddress.company_id) == (companyList.id)"
                                                >{{ companyAddress.address }}</td>
                                                <td
                                                    v-if="(companyAddress.company_id) == (companyList.id)"
                                                >{{ companyAddress.mobile }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="card card-bordered card-stretch">
                            <div class="card-inner">
                                <table
                                    class="datatable-init-export nowrap bor_table"
                                    data-export-title="Export" >
                                    <tr>
                                        <td>
                                            <b>Main City</b>
                                        ...
                                        <div
                                            v-for="(companyCity, index) in companyCity"
                                            :key="index" >
                                            <td
                                                v-if="(companyList.company_city) == (companyCity.id)"
                                            >{{ companyCity.name }}</td>
                                        </div>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <div
                                            v-for="(multipleEmails, index) in multipleEmails"
                                            :key="index" >
                                            <td
                                                v-if="(multipleEmails.company_id) == (companyCity.id)"
                                            >{{ multipleEmails.email_id }}</td>
                                        </div>
                                    </tr>
                                    <tr>
                                        <td class="table_border">
