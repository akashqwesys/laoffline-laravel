    ...
    export default {
        ...
        methods: {
            ...
            clearallfilter(event) {
                $('#reference_filter').find("input[type=search]").val('');
                $('#reference_filter').find("input[type=date]").val('');
