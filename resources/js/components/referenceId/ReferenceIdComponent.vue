                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 text-right">
                                        <a v-bind:href="create_reference" class="dropdown-toggle btn btn-icon btn-primary mx-2"><em class="icon ni ni-plus"></em></a>
    ...
    export default {
        ...
        methods: {
            ...
            clearallfilter(event) {
                $('#reference_filter').find("input").val('');
                $('#referenceTable').DataTable().clear().draw();
            },
        },
        mounted() {
            const self = this;
