                    ...
                    <div class="nk-block">
                        <div class="card card-bordered card-stretch">
                            ...
                            <div class="card-inner">
                                <table id="designation" class="table table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Name</th>
    ...
    export default {
        ...
        methods: {
            ...
            clearallfilter(event) {
                ...
                $('#designation').DataTable().search("").draw();
            },
        },
        mounted() {
            var buttons = [];
            ...
            function init_dt_table () {
                dt_table = $('#designation').DataTable({
                    processing: true,
                    serverSide: true,
                    lengthChange: true,
                    ajax: {
                        ...
                        data: function (data) {
                            if ($('#designation_filter input').val() == '') {
                                data.search.value = '';
                            }
                        },
            ...
            var draw = 1;
            $(document).on('keyup', '#designation_filter input', function(e) {
                if ($(this).val() == '') {
                    if (draw == 0) {
                        dt_table.clear().draw();
                        draw = 1;
