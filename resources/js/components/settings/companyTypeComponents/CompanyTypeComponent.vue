                    ...
                    <div class="nk-block">
                        <div class="card card-bordered card-stretch">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <h3 class="nk-block-title page-title">Company Types</h3>
                                    </div>
                            ...
                            <div class="card-inner">
                                <table id="companyType" class="table table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Category Name</th>
    ...
    export default {
        ...
        methods: {
            ...
            clearallfilter(event) {
                ...
                $('#companyType').DataTable().search("").draw();
            },
        },
        mounted() {
            var buttons = [];
            ...
            function init_dt_table () {
                dt_table = $('#companyType').DataTable({
                    processing: true,
                    serverSide: true,
                    lengthChange: true,
                    ajax: {
                        ...
                        data: function (data) {
                            if ($('#companyType_filter input').val() == '') {
                                data.search.value = '';
                            }
                        },
            ...
            var draw = 1;
            $(document).on('keyup', '#companyType_filter input', function(e) {
                if ($(this).val() == '') {
                    if (draw == 0) {
                        dt_table.clear().draw();
                        draw = 1;
