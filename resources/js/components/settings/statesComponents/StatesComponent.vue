                    ...
                    <div class="nk-block">
                        <div class="card card-bordered card-stretch">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 text-right">
                                        <a v-bind:href="create_states" class="dropdown-toggle btn btn-icon btn-primary mx-2"><em class="icon ni ni-plus"></em></a>
                            ...
                            <div class="card-inner">
                                <table id="state" class="table table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>State Name</th>
