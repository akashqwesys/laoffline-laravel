                    ...
                    <div class="nk-block">
                        <div class="card card-bordered card-stretch">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 text-right">
                                        <a v-bind:href="create_bankdetail" class="dropdown-toggle btn btn-icon btn-primary mx-2"><em class="icon ni ni-plus"></em></a>
                            ...
                            <div class="card-inner">
                                <table class="table table-hover table-bordered" id="bankDetails">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Name</th>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                create_bankdetail: 'bank-details/create-bank-details',
            }
        },
        created() {
        },
        methods: {
            ...
            clearallfilter(event) {
                ...
                $('#bankDetails').DataTable().search("").draw();
            },
        },
        mounted() {
            var buttons = [];
            ...
            function init_dt_table () {
                dt_table = $('#bankDetails').DataTable({
                    ...
                    ajax: {
                        ...
                        data: function (data) {
                            if ($('#bankDetails_filter input').val() == '') {
                                data.search.value = '';
                            }
                        },
