                    ...
                    <div class="nk-block">
                        <div class="card card-bordered card-stretch">
                            ...
                            <div class="card-inner">
                                <table class="table table-hover table-bordered" id="countries">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Country Name</th>
    ...
    export default {
        ...
        methods: {
            ...
            clearallfilter(event) {
                ...
                $('#countries').DataTable().search("").draw();
            },
        },
        mounted() {
            var buttons = [];
            ...
            var draw = 1;
            $(document).on('keyup', '#countries_filter input', function(e) {
                if ($(this).val() == '') {
                    if (draw == 0) {
                        dt_table.clear().draw();
                        draw = 1;
