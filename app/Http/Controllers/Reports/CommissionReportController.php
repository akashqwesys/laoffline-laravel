...
class CommissionReportController extends Controller
{
    ...
    public function listOutstandingCommissionData(Request $request) {
        ...
        $data1 = DB::table('payments as p1')
                ...
                ->where('p1.is_deleted', 0)->whereNot('p1.receipt_amount', 0)->where('p1.old_commission_status', 0)->orWhere('p1.customer_commission_status', 1)
        ...
        $data2 = DB::table('payments as p')
                ...
                ->where('p.is_deleted', 0)->whereNot('p.receipt_amount', 0)->where('p.old_commission_status', 0)->orWhere('p.customer_commission_status', 1)
            ...
            if ($request->show_detail == 1) {
                $data1 = DB::table('payments as p1')
                        ...
                        ->where('p1.is_deleted', 0)->whereNot('p1.receipt_amount', 0)->where('p1.customer_commission_status', 0)->orWhere('p1.old_commission_status', 1)
                ...
                $data2 = DB::table('payments as p')
                        ...
                        ->where('p.is_deleted', 0)->whereNot('p.receipt_amount', 0)->where('p.customer_commission_status', 0)->orWhere('p.old_commission_status', 1)
