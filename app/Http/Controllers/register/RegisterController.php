...
class RegisterController extends Controller
{
    ...
    public function listOutwardRegister(Request $request) {
        ...
        foreach($records as $record){
            ...
            if ($record->system_module_id == 5) {
                ...
                $action = '<a href="/register/outward/outward-view/'.$record->inward_or_outward_id. '" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="print"> <em class="icon ni ni-file-doc"></em></a><a href="/register/view-outward/'.$record->inward_or_outward_id. '" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="show" target="_blank"><em class="icon ni ni-eye"></em></a><a href="/register/edit-outward/'.$record->inward_or_outward_id.'" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Update"><em class="icon ni ni-edit-alt"></em></a>';
            } else if ($record->system_module_id == 15) {
                $action = '<a href="/register/view-inward/'.$record->inward_or_outward_id. '" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="show" target="_blank"><em class="icon ni ni-eye"></em></a><a href="/register/edit-inward/'.$record->inward_or_outward_id.'" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Update"><em class="icon ni ni-edit-alt"></em></a>';
            } else {
                $action = '';
    ...
    public function insertSampleOutward(Request $request) {
        ...
        $ouid_data->ouid = $ouid;
        $ouid_data->financial_year_id = $financialid;
        $ouid_data->save();
        ...
        $cmpTypeName = Company::where('id', $outward_data->company->id)->first();
