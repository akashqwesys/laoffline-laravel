...
class SalesRegisterExport implements /* FromCollection, WithHeadings, WithMapping, */ ShouldAutoSize, FromView
{
    ...
    {
        return view('reports.sales_register_export_sheet', [ 'data' => $this->data, 'request' => $this->request ]);
    }
