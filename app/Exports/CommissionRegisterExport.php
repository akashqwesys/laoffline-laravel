...
class CommissionRegisterExport implements /* FromCollection, WithHeadings, WithMapping, */ ShouldAutoSize, FromView
{
    ...
    {
        return view('reports.commission_register_export_sheet', [ 'data' => $this->data, 'request' => $this->request ]);
    }
